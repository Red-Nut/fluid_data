...
searchList = [
    ...
    Error(errorbase + '004','',''),
    Error(errorbase + '005','Type incorrect for well report','Type incorrect for well report'),
    Error(errorbase + '006','Not a well report: multiple permits','Not a well report: multiple permits'),
    Error(errorbase + '007','No Permit.','No Permit.'),
    Error(errorbase + '008','Error in title, type or gov_id','Error in title, type or gov_id'),
    Error(errorbase + '009','Error processing Well Name.','Error processing Well Name.'),
    ...
    Error(errorbase + '022','Database error - Failed to commit new Data Type to database','Database error - Failed to commit new Data Type to database'),
    Error(errorbase + '023','Database error - Failed to commit none well report to database.','Failed to commit none well report to database.'),
    Error(errorbase + '024','Report has no report type.','Report has no report type'),
    Error(errorbase + '025','Data has no type.','Data has no type'),
    Error(errorbase + '026','Database error - Failed to commit other data to database.','Failed to commit other data to database.'),
    Error(errorbase + '027','',''),
    Error(errorbase + '028','',''),
    Error(errorbase + '029','',''),
    Error(errorbase + '030','',''), 
