...
searchList = [
    ...
    Result(codeBase + "007",'No Permit.','No Permit.'),
    Result(codeBase + "008","API error","Result field data error"),
    Result(codeBase + "009","Error processing Well Name.","Error processing Well Name."),
    ...
    Result(codeBase + "023","No report type","No report type"),
    Result(codeBase + "024","Permit number invalid","Permit number invalid"),
    Result(codeBase + "025","Missing data","Missing data"),
    Result(codeBase + '026',"Not a well report: multiple permits.","Not a well report: multiple permits."),
    Result(codeBase + '027','No Permit','No Permit'),
    Result(codeBase + '028','Report has no report type','Report has no report type'),
    Result(codeBase + '029','Database error - Failed to commit none well report to database.','Failed to commit none well report to database.'),
    Result(codeBase + '030','Database error - Failed to commit new Data Type to database','Database error - Failed to commit new Data Type to database'),
    Result(codeBase + '031','Connection Error.','Connection Error.'), 
    Result(codeBase + '032','State not implemented.','State not implemented.'), 
    Result(codeBase + '033','Retrieve function failed.','Retrieve function failed.'), 
...
convertList = [
    ...
    Result(codeBase + "009", "Google Cloud Error", "Google Cloud Error"),
